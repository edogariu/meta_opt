...
def run(seeds, cfg):
    ...
    for s in seeds:
        ...
        # ours
        opt = optax.inject_hyperparams(optax.adamw)(learning_rate=6e-4, b1=0.9, b2=0.999)
        results['ours'].append(train_meta_opt(CFG, counterfactual=True, H=16, HH=2, meta_optimizer=opt, initial_lr=1.0, grad_clip=1))
