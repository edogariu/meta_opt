...
def run(seeds, cfg):
    ...
    for s in seeds:
        ...
        benchmarks = {
            ...
            'momentum_0.3': optax.chain(optax.add_decayed_weights(1e-4), optax.inject_hyperparams(optax.sgd)(learning_rate=0.3, momentum=0.9)),
            'momentum_0.1': optax.chain(optax.add_decayed_weights(1e-4), optax.inject_hyperparams(optax.sgd)(learning_rate=0.1, momentum=0.9)),
