...
CFG = {
    ...
    # experiment options
    'experiment_name': 'wmt_fullbatch_2',
...
def run(seeds, cfg):
    ...
    for s in seeds:
        ...
        results['cf_adam_1e-3_clip0.1'].append(train_meta_opt(CFG, counterfactual=True, H=16, HH=2, meta_optimizer=opt, initial_lr=1.0, grad_clip=0.1))
