...
def load_wmt(cfg, dataset_dir: str = './datasets') -> Tuple[tf.data.Dataset, tf.data.Dataset, List[int], Callable, Callable]:
    ...
    return train_ds, test_ds, example_input, _compute_weighted_cross_entropy, {'loss': _compute_weighted_cross_entropy, 'acc': _compute_weighted_accuracy}, tokenizer  # train dataset, test dataset, unbatched input dimensions, loss function, eval metrics
